...
let inMemoryState: any = {
  ...
  persona: {
    identityName: 'Alex',
    tagline: 'Tech explorer, minimalist desk builder, and coffee enthusiast.',
    humorLevel: 7,
    sarcasmLevel: 4,
    warmth: 7,
    slangFrequency: 5,
    ...
    opinionatedness: 7,
    postLength: 'varied',
    nicheTopics: ['desk setup', 'remote work lifestyle', 'minimalist gadgets', 'everyday tech', 'coffee habits'],
    topicsToAvoid: ['politics', 'crypto spam', 'hard-sell marketing', 'toxic debates'],
  },
  recentTopics: ['desk organization', 'monitor arms', 'morning routines'],
  recentHooks: [],
  recentPhrases: [],
  recentProducts: [],
  peopleToFollowUp: [],
